...
var FormActions = function FormActions() {
  ...
  this.generateActions('handleUsernameChange', 'handlePasswordChange', 'handleConfirmedPasswordChange', 'handleFirstNameChange', 'handleLastNameChange', 'handleAgeChange', 'handleGenderChange', 'usernameValidationFail', 'passwordValidationFail');
};
  ...
  _createClass(UserActions, [{
    ...
    value: function loginUser() {
      ...
      $.ajax(request).done(function (data) {
        ...
        return _this2.loginUserFail(err);
      });
...
},{"../stores/UserStore":71,"./sub-components/UserInfo":59,"./sub-components/UserRatedMovies":60,"./sub-components/UserReviews":62,"react":"react"}],46:[function(require,module,exports){
'use strict';
...
var UserRegister = function (_React$Component) {
  ...
  _createClass(UserRegister, [{
    ...
    value: function handleSubmit(e) {
      ...
      if (!data.username) {
        return _FooterActions2.default.usernameValidationFail();
      }
      if (!data.password || !data.confirmedPassword || data.password !== data.confirmedPassword) {
        return _FooterActions2.default.passwordValidationFail();
      }
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_TextGroup2.default, { type: 'text',
          ...
          autoFocus: true,
          handleChange: _FooterActions2.default.handleUsernameChange,
          validationState: this.state.usernameValidationState,
          message: this.state.message }),
        _react2.default.createElement(_TextGroup2.default, { type: 'password',
          label: 'Password',
          value: this.state.Password,
          handleChange: _FooterActions2.default.handlePasswordChange,
          validationState: this.state.passwordValidationState,
          message: this.state.message }),
        _react2.default.createElement(_TextGroup2.default, { type: 'password',
          label: 'Confirm Password',
          value: this.state.confirmPassword,
          handleChange: _FooterActions2.default.handleConfirmedPasswordChange,
          validationState: this.state.passwordValidationState,
          message: this.state.message }),
        _react2.default.createElement(_TextGroup2.default, { type: 'text',
          label: 'First Name',
          handleChange: _FooterActions2.default.handleFirstNameChange,
          value: this.state.firstName }),
        _react2.default.createElement(_TextGroup2.default, { type: 'text',
          label: 'Last Name',
          handleChange: _FooterActions2.default.handleLastNameChange,
          value: this.state.lastName }),
        _react2.default.createElement(_TextGroup2.default, { type: 'number',
          label: 'Age',
          handleChange: _FooterActions2.default.handleAgeChange,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_RadioElement2.default, { groupName: 'gender',
            ...
            handleChange: _FooterActions2.default.handleGenderChange }),
          _react2.default.createElement(_RadioElement2.default, { groupName: 'gender',
            value: 'Female',
            selectedValue: this.state.gender,
            handleChange: _FooterActions2.default.handleGenderChange })
...
},{"../actions/FooterActions":33,"../actions/UserActions":38,"../stores/FormStore":67,"./form/Form":47,"./form/RadioElement":48,"./form/RadioGroup":49,"./form/Submit":50,"./form/TextGroup":51,"react":"react"}],47:[function(require,module,exports){
'use strict';
...
},{"./MovieCommentsPanel":53,"./MovieInfo":54,"./MoviePanelsToggle":55,"./MoviePoster":56,"./MovieVotePanel":57,"react":"react"}],53:[function(require,module,exports){
"use strict";
...
var MoviePanelToggles = function (_React$Component) {
    ...
    function MoviePanelToggles(props) {
        _classCallCheck(this, MoviePanelToggles);

        return _possibleConstructorReturn(this, (MoviePanelToggles.__proto__ || Object.getPrototypeOf(MoviePanelToggles)).call(this, props));
    }
...
},{"./UserRatedMoviesPanel":61,"react":"react"}],61:[function(require,module,exports){
'use strict';
...
},{"./MovieCard":52,"react":"react"}],62:[function(require,module,exports){
'use strict';
...
},{"./UserReviewsPanel":63,"react":"react"}],63:[function(require,module,exports){
'use strict';
...
},{"../components/sub-components/MovieCommentsPanel":53,"../components/sub-components/MovieVotePanel":57,"react":"react","react-router":"react-router"}],73:[function(require,module,exports){
'use strict';
